...
<ul>
  ...
  <li>
    ...
    <ul>
      <li><span class="inline-expand" onclick="toggleInline(this, event)">In natural systems<span class="inline-body" style="display:none;">, useful physical models often approximate interactions as primarily local, giving rise to sparse decompositions. In designing a crystal to minimize formation energy or maximize bonding energy, for example, one might model atoms in a lattice as only directly interacting with their nearest neighbors.
