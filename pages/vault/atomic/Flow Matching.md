...
date modified: Wednesday, January 29th 2025, 10:23:12 pm
---
...
![image](img/Pasted image 20250124184811.png)
...
Flow matching objective: given a target density $$p_t(x)$$ and the vector field that generates it $$u_t(x)$$[^3], fit $$v_{t}(x;\theta)$$ to match the target flow.![image](img/Pasted image 20250124164548.png)
...
![image](img/Pasted image 20250124170735.png)
...
![image](img/Pasted image 20250124174647.png)
We can also just solve for $$u$$ then, because $$\psi$$ is simple and invertible: **(Thm. 3)**
![image](img/Pasted image 20250124175211.png)

### Fitting other frameworks into flow matching
![image](img/Pasted image 20250124180147.png)
...
![image](img/Pasted image 20250124181627.png)
