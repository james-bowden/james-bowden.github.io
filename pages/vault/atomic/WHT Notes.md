...
date modified: Monday, January 27th 2025, 1:57:38 pm
---
...
![[Pasted image 20250122092936.png]]
...
![[Pasted image 20250127135329.png|400]]
...
LR --> $\epsilon = V \cdot (X^{T}\cdot S) \cdot H$, $S = QQ^T$, the identity matrix w/ zeros on diagonal w/ order $\gt r$. Note that this can be written also with omission of $X^T$ and I believe this is what [[gWHT Notes]] does, though this may bring about issues of having more coefficients than datapoints. ??
![[Pasted image 20250122092955.png]]

# Connections
## Sparse optimization approach

Mentions solving the following problem: ![[Pasted image 20250124023238.png|300]]
